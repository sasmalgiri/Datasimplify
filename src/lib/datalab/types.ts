...
export const DATA_SOURCE_OPTIONS: {
  ...
  { source: 'volume', label: 'Volume', chartType: 'bar', yAxis: 'right', gridIndex: 1, color: '#60a5fa', endpoints: ['ohlc'] },
  ...
  { source: 'btc_dominance', label: 'BTC Dominance %', chartType: 'line', yAxis: 'right', gridIndex: 0, color: '#fbbf24', endpoints: ['global'] },
  { source: 'funding_rate', label: 'Funding Rate', chartType: 'bar', yAxis: 'right', gridIndex: 1, color: '#2dd4bf', endpoints: ['derivatives'] },
  { source: 'defi_tvl', label: 'DeFi TVL', chartType: 'area', yAxis: 'right', gridIndex: 0, color: '#818cf8', endpoints: ['defillama_protocols'] },
];
