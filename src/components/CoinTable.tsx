...
import { formatCurrency, formatPercent, formatNumber, getPriceChangeColor } from '@/lib/utils';
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50 sticky top-0 z-10">
            <tr>
              ...
              <SortHeader label="Price" sortKeyName="current_price" />
              <SortHeader label="24h %" sortKeyName="price_change_percentage_24h" />
              <SortHeader label="7d %" sortKeyName="price_change_percentage_7d" />
              <SortHeader label="Market Cap" sortKeyName="market_cap" />
              <SortHeader label="Volume (24h)" sortKeyName="total_volume" />
